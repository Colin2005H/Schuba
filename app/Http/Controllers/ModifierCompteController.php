...
class ModifierCompteController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('modifierCompte', compact('info_compte','club')); 
    }
    public function update(Request $request, $id){

        if ($request->input('action') == 'Annuler'){
            ...
            if($request->input('uti_mail') != $info_compte[0]->UTI_MAIL){
            ...
            return redirect()->route('listUser')->with('success', "L'utilisateur a bien été modifié");
