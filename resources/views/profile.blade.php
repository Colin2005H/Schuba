        ...
        <div class="flex flex-col min-h-screen bg-cover bg-center">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md sm:w-96 items-center justify-center mx-auto my-auto">
                <h2 class="text-xl font-semibold text-center mb-6">
                    {{ strtoupper($user->UTI_NOM) . ' ' . $user->UTI_PRENOM }}
                </h2>
                ...
                <div id="address">Adresse :
                    {{ $user->UTI_ADRESSE . ', ' . $user->UTI_CODE_POSTAL . ' ' . $user->UTI_VILLE }}
                </div>
                ...
                @if ($role != 'directeur_technique')
                    <button onclick="alertSuppAccount()"
                        class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Supprimer
                        un compte</button>
                @endif
                </br>
                </br>
                @if ($role != 'directeur_technique')
                    <a href="{{ route('changeData.showPassword') }}"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Modifier le mot de passe
                    </a>
                    </br>
                    </br>
                    <a href="{{ route('changeData.showEmail') }}"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
