...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="container w-full place-content-center place-self-center">
        ...
        <!-- Section de contenu -->
        <div class="flex flex-col md:flex-row py-10 px-4 items-center justify-center">
            <div class="w-full md:w-2/3">
            <p class="text-lg leading-7 text-center md:text-left">
                Bienvenue sur SCHUBA, notre site dédié à la passion de la plongée sous-marine. Réservé à nos membres, ce site permet de consulter votre emploi du temps de séances et vos progrès en toute simplicité.
            </p>
            </div>
