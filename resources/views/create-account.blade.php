...
<body class="bg-gray-100">
    @include('header')
    <div class="bg-[url('/img/scub1.png')] bg-cover bg-no-repeat bg-center p-10">
        @if (session('success'))
            ...
            <form method="POST" action="" style="margin-bottom: 10px;">
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_nom" name="uti_nom" value="" placeholder="Nom"
                            class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </label>
                    @error('uti_nom')
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_prenom" name="uti_prenom" value="" placeholder="Prénom"
                            class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </label>
                    @error('uti_prenom')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_code_postal" name="uti_code_postal" value=""
                    ...
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_adresse" name="uti_adresse" value="" placeholder="Adresse"
                            class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </label>
                    @error('uti_adresse')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_ville" name="uti_ville" value="" placeholder="Ville"
                            class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </label>
                    @error('uti_ville')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 text-gray-700">
                        <input type="text" id="uti_mail" name="uti_mail" value="" placeholder="Adresse email"
                            class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </label>
                    @error('uti_mail')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="clu_id" name="clu_id" value="{{ $clubDirector[0]->CLU_NOM }}"
                        class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                        readonly>
                ...
                <div class="mb-4">
                    <select name="uti_niveau" id="niveauUser"
                        class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                ...
                <div class="mb-4">
                    ...
                    <input id="uti_date_naissance" type="date" name="uti_date_naissance" value="1950-01-01"
                ...
                <div class="mb-4">
                    ...
                    <input id="uti_date_certificat" type="date" name="uti_date_certificat" value="1950-01-01"
                        min="1950-01-01" max="2025-"
                        class="w-full px-3 py-2 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400" />
                ...
                <button class="flex items-center justify-center text-white hover:bg-blue-500 p-4 rounded-md"
                    style="background-color: rgba(23, 34, 49, 1);">Enregistrer</button>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        niveau.addEventListener('change', function() {
            ...
            if (student.checked) {
                var valueFormation = parseInt(niveau.value) + 1
                document.getElementById("studentFormation").textContent = 'Formation de niveau ' + valueFormation +
                    ' pour cette année';
            }
