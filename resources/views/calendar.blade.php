...
<head>
    ...
    @include('header')
    <div class="calendar bg-[url('img/underwater.png')]">
        <h1 class="font-bold text-[#004B85] text-center text-2xl m-4">Calendrier des séances</h1>
        <div id='calendar' class="bg-[rgb(255,255,255,0.8)]">
            <script>
                ...
                function resizeCaldendar() {
                    ...
                    if (calendarTem.initialView != (isMobile ? 'timeGridDay' : 'timeGridWeek')) {
                        ...
                        calendar = new FullCalendar.Calendar(document.getElementById('calendar'),
                            calendarTem); // Recréer le calendrier avec les nouvelles options
    ...
    <div class="hidden fixed inset-0 z-10 bg-opacity-75 bg-gray-500 flex items-center justify-center place-content-center place-items-center align-content-center min-h-screen w-full"
        id="popup">
        <div class="bg-white rounded-lg p-6 w-full max-w-md text-center">
            <form action="" method="POST">
                ...
                <button id="close" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded mx-auto"
                    onclick="document.getElementById('popup').style.display = 'none';" type="button">Fermer</button>
                <?php
                ...
                <button id="modif" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded mx-auto min-w-20">
                    Modifier
                </button>
                <?php endif; ?>

                @if ($role === 'eleve')
                    <button id="bilan" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded mx-auto min-w-20">
                        Bilan
                    </button>
                @endif
